 ...
 */
final class Version20200130141642 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD forum_id INT DEFAULT NULL, ADD creation_date DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP forum_id, DROP creation_date');
    }
}
